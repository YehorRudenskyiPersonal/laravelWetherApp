...
return [
    'route' => [
        ...
        'middleware' => [
            App\Http\Middleware\CheckXToken::class
        ],
    ...
    'schemas' => [
        'default' => [
            'query' => [
                'temperatureByCity' => App\GraphQL\Queries\TemperatureByCityQuery::class,
                'temperatureByDate' => App\GraphQL\Queries\TemperatureByDateQuery::class,
                'temperatureByCityAndDate' => App\GraphQL\Queries\TemperatureByCityAndDateQuery::class,
            ],
            'mutation' => [
